/*
 *	SecondAgent.java / Active Agents Info 2
...
public class SecondAgent extends Agent {
	...
	protected void setup() {
		...
		addBehaviour(new OneShotBehaviour() {
			@Override
			public void action() {
				System.out.println("Second Agent - Requesting Information");
		...
		addBehaviour(new CyclicBehaviour() {
			...
			public void action() {
				...
				if (msg != null && msg.getContent().equalsIgnoreCase("Name")) {
					...
					System.out.println(" Message Received in Second Agent from " + msg.getSender().getName()
